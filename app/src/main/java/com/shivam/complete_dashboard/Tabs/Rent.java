...
{
    //Views
    private View mFlatView, mAdFooterView, mAdHeaderView;
                             ...
                             Bundle savedInstanceState)
    {
        ...
        mFlatView = inflater.inflate(R.layout.tab_hostel, container, false);
...
//                });
    ...
    private void init()
    {
        ...
        mADList =  mFlatView.findViewById(R.id.ad_list);
    ...
    public void onStart()
    {
        ...
        firebaseRecyclerAdapter = new FirebaseRecyclerAdapter<Advertise, AdViewHolder>(
                new FirebaseRecyclerOptions.Builder<Advertise>()
                        .setQuery(mAdDatabase.child("Rent"), Advertise.class)
                        .build())
        {
            @Override
